...
const Elegant = lazy(
  () => import("../pages/collections/collections-cookers/children/Elegant")
);
const Perfection = lazy(
  () => import("../pages/collections/collections-cookers/children/Perfection")
);
const Mixture = lazy(
  () => import("../pages/collections/collections-cookers/children/Mixture")
);
const Antique = lazy(
  () => import("../pages/collections/collections-cookers/children/Antique")
);
const CollectionsHobs = lazy(
  () => import("../pages/collections/collections-hobs/CollectionsHobs")
);
const LandHobs = lazy(
  () => import("../pages/collections/collections-hobs/children/LandHobs")
);
const EnzoHobs = lazy(
  () => import("../pages/collections/collections-hobs/children/EnzoHobs")
);
const NeroLineCollection = lazy(
  () => import("../pages/collections/nero-line-collection/NeroLineCollection")
);
...
const EnzoTitanOvens = lazy(
  () => import("../pages/collections/collections-ovens/children/EnzoTitanOvens")
);
const EnzoOvens = lazy(
  () => import("../pages/collections/collections-ovens/children/EnzoOvens")
);
const ExpertOvens = lazy(
  () => import("../pages/collections/collections-ovens/children/ExpertOvens")
);
  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        // nero-line-collection
        {
          path: "collections/nero-line-collection",
          element: <NeroLineCollection />,
        },
        //-- collections-cookers
        {
        ...
        {
          path: "collections/collections-cookers/elegant",
          element: <Elegant />,
        },
        {
          path: "collections/collections-cookers/perfection",
          element: <Perfection />,
        },
        {
          path: "collections/collections-cookers/mixture",
          element: <Mixture />,
        },
        {
          path: "collections/collections-cookers/antique",
          element: <Antique />,
        },
        //-- collections-hobs
        { path: "collections/collections-hobs", element: <CollectionsHobs /> },
        {
          path: "collections/collections-hobs/land-hobs",
          element: <LandHobs />,
        },
        {
          path: "collections/collections-hobs/enzo-hobs",
          element: <EnzoHobs />,
        },
        //-- collections-ovens
        {
        ...
        {
          path: "collections/collections-ovens/enzo-titan-ovens",
          element: <EnzoTitanOvens />,
        },
        {
          path: "collections/collections-ovens/enzo-ovens",
          element: <EnzoOvens />,
        },
        {
          path: "collections/collections-ovens/expert-ovens",
          element: <ExpertOvens />,
        },
        // other routes
