...
const Logo = ({ isScrolled }: LogoProps) => {
  ...
  const whitePaths = [
    ...
    "/collections/collections-cookers/antique/",
    "/collections/collections-cookers/perfection/",
    "/collections/collections-cookers/mixture/",
    "/collections/collections-cookers/Elegant/",
