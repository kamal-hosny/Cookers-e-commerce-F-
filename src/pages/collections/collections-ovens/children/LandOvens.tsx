...
const LandOvens = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Land Built-in Ovens | BULM Italy</title>
        <meta
          name="description"
          content="Explore BULM’s Land Collection of built-in ovens — rustic, timeless design blended with modern performance. Discover electric multifunction ovens featuring Idroclean and traditional country style."
        />
        <meta
          name="keywords"
          content="Land ovens, BULM, built-in ovens, rustic ovens, traditional kitchen appliances, Idroclean, electric multifunction oven, country chic style"
        />
        <meta property="og:title" content="Land Built-in Ovens | BULM Italy" />
        <meta
          property="og:description"
          content="Inspired by tradition, the Land Collection by BULM offers timeless built-in ovens with elegant brass details and easy-clean Idroclean function."
        />
        <meta
          property="og:image"
      ...
      <div>
        ...
        <div className="container relative z-5 pt-[580px] pb-20 space-y-8">
          ...
          <MainTitleCollections title="Land Collection. Inspired by tradition">
            <p>
              For those who love a touch of "Country Chic" style in the kitchen
              and prefer the nuances of material colours,{" "}
              <strong>Land Collection built-in ovens</strong> are the ideal
