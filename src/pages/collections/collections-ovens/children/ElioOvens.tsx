...
const products: IProduct[] = [
  {
    ...
    title: "Elio electric multifunction oven",
    code: "EL 11 XLB 300",
  },
  {
    id: 2,
  ...
  return (
    <div>
      <HeadCollection image="https://www.elba-cookers.com/wp-content/uploads/2022/03/elba-elio-collection-oven.jpg.webp" />
        ...
        <MainTitleCollections title="Elio Collection. Seamless integration between style and efficiency">
          <p>
            Innovation and appeal are revealed in the{" "}
            <strong>Elio built-in models</strong>. Top-quality materials,
            ...
            <strong>Elio Collection</strong> has simple, ergonomic lines in an
            exclusive style.
          </p>
